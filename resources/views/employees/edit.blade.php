        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" value="{{$data->type_of_employee=='hourly' ? $data->amount_per_hour : $data->monthly_rate }}"  placeholder="Rate" name="rate" class="form-control form-control-sm @error('rate') is-invalid @enderror">
                    @error('rate')
                    <span class="invalid-feedback" role="alert">
                       <strong>{{ $message }}</strong>
                    </span>
