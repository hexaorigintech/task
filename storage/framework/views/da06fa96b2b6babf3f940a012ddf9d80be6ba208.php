...
<div class="row">
    <?php if(\Session::has('ImportedRec') && \Session::has('totalRec')): ?>
    <div class="alert alert-danger" role="alert">
        <i class="dripicons-wrong me-2"></i> <strong><?php echo e(\Session::get('ImportedRec')); ?></strong> has been imported out of <strong><?php echo e(\Session::get('totalRec')); ?></strong>
    </div>
    <?php endif; ?>
</div>
<div class="card">
               ...
               <tbody>
                ...
                <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <tr>
                   ...
                   <td class="text text-capitalize"><?php echo e($data->type_of_employee); ?> <?php if($data->type_of_employee=="hourly"): ?> <span style="font-size: 12px !important" class="badge badge-dark-lighten">  ( hrs <?php echo e($data->number_of_hours); ?> rate <?php echo e($data->amount_per_hour); ?>) </span>  <?php endif; ?> </td>
                   <td><?php echo e($data->monthly_rate); ?></td>
 ...
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\task2\resources\views/employees/index.blade.php ENDPATH**/ ?>